> **Nota:** Estas notas han sido elaboradas por mí, Polina Yakovenko, como parte de mi estudio personal del curso *Gestión Empresarial*, impartido por el profesor **Mateo Manuel Córcoles Muñoz** en la Universidad de Castilla-La Mancha (UCLM).  
...
Al principio, los economistas clásicos como Adam Smith pensaban que el empresario era simplemente la persona que tenía el dinero y los recursos. No hacía falta que hicieras mucho más, porque el mercado (la "mano invisible") se encargaría de todo lo demás por sí solo.
...
De esta manera, cuando un empresario genera una innovación, obtiene un beneficio. Obviamente, si el producto funciona, será imitado por otros y sus beneficios disminuirán, por lo que habrá que seguir buscando nuevas innovaciones. Este proceso de innovación-imitación-innovación fue bautizado por Schumpeter como “_Destrucción creativa_”.

Innovación -> Monopolio, ventaja competitiva -> Beneficio -> Imitacion de innovación -> Generalización de la empresa -> Nuevo equilibrio -> nueva innovación
...
**El empresario como tecnoestructura:**  Una vez que las empresas son mayores, para poder conseguir el capital necesitan de muchos accionistas o socios que aporten capital. Es complicado que todos estos socios se reúnan a menudo y lleguen a acuerdos. Además, para dirigir una empresa se requieren muchos conocimientos que no tienen los propietarios. Por estos motivos, las grandes empresas delegan la dirección en un conjunto de profesionales que son expertos en sus áreas (economistas, ingenieros etc.). Para Galbraith, el empresario es este grupo de personas expertas de distintas áreas que dirige, y que llamó tecnoestructura.
...
* Socios industriales: Son los que solo aportan trabajo (no capital), y por norma general no participan en la gestión.
* Responsabilidad ilimitada: Los socios responden con su patrimonio personal si hay deudas. No hay protección legal como en una sociedad limitada.
* No hay capital social mínimo: Puede constituirse con la cantidad que los socios acuerden.
* No se puede vender o ceder la participación a otra persona sin el consentimiento del resto.
...
Es una sociedad personalista, como la colectiva, pero en la que conviven dos tipos de socios con responsabilidades diferentes. Tipos de socios:

* Socios colectivos: gestionan la empresa directamente, tienen responsabilidad ilimitada
...
* El nombre de la empresa (razón social) debe incluir el nombre de uno o varios socios, seguido de: “y Compañía” o “y Cía.” y la fórmula legal “Sociedad en Comandita”, “S. en C.” o “S. Com.”

Es útil cuando: Algunos socios quieren dirigir la empresa y asumir riesgos y otros solo quieren invertir dinero y no involucrarse en la gestión.

### Sociedad comanditaria por acciones

Es una variante de la sociedad comanditaria, pero adaptada al modelo de grandes empresas, ya que su capital está dividido en acciones y requiere una inversión mínima elevada.

* Sociedad capitalista: A diferencia de las sociedades personalistas (como la colectiva), aquí prima el capital aportado, no tanto la identidad de los socios.
* Dos tipos de socios: Socios colectivos (gestionan la empresa, tienen responsabilidad ilimitada); Socios comanditarios ( aportan dinero, no participan en la gestión, tienen responsabilidad limitada al capital invertido)
* Mínimo 2 socios, y al menos uno debe ser colectivo (gestor).
* Capital social mínimo: 60.000 euros, debe estar dividido en acciones.
* Las acciones son propiedad de los socios comanditarios.
* Nombre de la empresa: Puede ser cualquier nombre, pero debe incluir la expresión: “Sociedad en Comandita por Acciones” o “S. en Com. por A.”
...
* Puede formarse con: 1 socio (S.L.U. – Sociedad Limitada Unipersonal) o 2 o más socios (S.L.).
* Capital social mínimo tradicional: 3.000 € (dividido en participaciones, no acciones). Sin embargo, desde la Ley 18/2022, ahora se puede constituir con solo 1 €. Pero hasta alcanzar los 3.000 €, se deben cumplir condiciones: Reservar al menos el 20% de los beneficios hasta llegar a los 3.000 €. Si la empresa quiebra antes de alcanzar esos 3.000 €, los socios deben cubrir la diferencia con su patrimonio personal.
* Responsabilidad limitada: los socios solo responden hasta el capital que han aportado. Su patrimonio personal está protegido (salvo lo explicado antes con la nueva ley).
* Distribución de beneficios y votos: se hace en proporción al capital aportado.
* Nombre o razón social: cualquier nombre elegido por los socios, seguido de: “Sociedad de Responsabilidad Limitada”, o “Sociedad Limitada”, o las siglas “S.R.L.” o “S.L.”.
...
* Puede tener: 1 solo socio (S.A.U. – Sociedad Anónima Unipersonal), o 2 o más socios (personas físicas o jurídicas).
* Capital social mínimo: 60.000 euros, dividido en acciones (no participaciones).
* Estas acciones pueden transmitirse libremente, lo que facilita la entrada de nuevos inversores.
* Hay separación entre propiedad y control: Los accionistas eligen a un órgano de administración para gestionar, y deciden en la Junta General de Accionistas.
* Los beneficios y los votos se distribuyen en función del número de acciones que posee cada socio.
* Responsabilidad limitada: los socios solo responden hasta el importe de su aportación. Su patrimonio personal está protegido.
* Razón social: cualquier nombre elegido por los socios, seguido de la fórmula: “Sociedad Anónima” o “S.A.”
* Al menos el 51% del capital está en manos de los trabajadores socios.
...
* Finalidad: satisfacer necesidades de los socios (trabajo, consumo, producción) y contribuir al progreso social.
* Capital social mínimo: lo establece el estatuto de la cooperativa, no una ley fija.
* Sin ánimo de lucro: pueden generar beneficios, pero no se reparten según el capital aportado, sino según el trabajo o servicios prestados por el socio.
* Responsabilidad limitada: los socios no responden con su patrimonio personal, solo con lo que hayan aportado a la cooperativa.
...
* De servicios diversos: orientadas a necesidades específicas (educación, salud, vivienda, etc.).
